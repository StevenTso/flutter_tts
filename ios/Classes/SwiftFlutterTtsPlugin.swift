...
public class SwiftFlutterTtsPlugin: NSObject, FlutterPlugin, AVSpeechSynthesizerDelegate {
  ...
  init(channel: FlutterMethodChannel) {
    ...
    do {
      try AVAudioSession.sharedInstance().setCategory(AVAudioSessionCategoryAmbient, mode: AVAudioSessionModeSpokenAudio, options: [AVAudioSessionCategoryOptions.mixWithOthers])
